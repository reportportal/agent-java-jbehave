...
The latest version: 5.5.6. Please use `Maven Central` link above to get the agent. **For JBehave version 5.0 and
higher**
...
dependencies {
    ...
    testCompile 'com.epam.reportportal:agent-java-jbehave:5.5.6'
