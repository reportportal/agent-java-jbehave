...
The latest version: 5.1.0. Please use `Download` link above to get the agent. Minimal supported JBehave version: 4.8
...
dependencies {
    ...
    testCompile 'com.epam.reportportal:agent-java-jbehave:5.1.0'
